...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setFormStatus({ submitted: true, success: false, message: 'Sending...', loading: true });

    try {
      // Using FormSubmit.co - reliable free email service
      ...
      const response = await fetch('https://formsubmit.co/deepugopisetti@gmail.com', {
        method: 'POST',
        body: formDataToSend,
      });
